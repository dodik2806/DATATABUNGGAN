...
export default function FinancialDiary() {
  ...
  // Calculate total assets (cash + btc + tabungan - hutang)
    ...
    <div className={`app-container ${darkMode ? "dark-mode" : ""}`}>
      ...
      <div className="diary-container">
        <div className="header-container">
          <h1 className="diary-title">TABUNGGAN RADEN & FITRI </h1>
              ...
              <div className="wallet-form-body">
                ...
                <div className="wallet-input-container">
                  ...
                  <input
                    ...
                    value={walletInput}
                    onChange={(e) => {
                      // Allow any numeric input for wallet
                      const inputValue = e.target.value;
                      if (
                        inputValue === "" ||
                        /^[0-9]*\.?[0-9]*$/.test(inputValue)
        ...
        <div className="modal-overlay">
          <div className="modal-container">
            ...
            <div className="modal-body">
              <p>
                Apakah Anda yakin ingin menghapus semua data transaksi dan saldo
                dompet?
              </p>
            ...
            <div className="modal-footer">
              ...
              <button className="modal-confirm-btn" onClick={resetAllData}>
                Ya, Reset Semua
              </button>
            </div>
          </div>
